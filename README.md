...
The team is always here to help you. Happen to face an issue? Want to report a bug? You can submit one here on Github using the [Issue Tracker](https://github.com/zain4picker/Picker-CLI/issues/new). If you still have any questions, please contact us by joining the Picker Global Developer Community on [Telegram](https://t.me/zain4picker) or via the [Support Email](mailto:contact@picker.sd)
...
If you discover any securitys-related issues, please email security@picker.sd instead of using the issue tracker.


## Credits

- [Picker](https://github.com/zain4picker)
